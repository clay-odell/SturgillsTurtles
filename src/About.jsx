  ...
  return (
    <>
      ...
      <p className="about">
        ...
        country singer, but their musical influences span everything from
        classic country, 90s rock, to improvisational music like Phish, Grateful
        Dead, and Widespread Panic.
      </p>
    </>
  );
};
